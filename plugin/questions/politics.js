_OKCP.fileQuestions.politics = {
  class_conscious: [
    ...
    },
    {
      qid: "42015",
      text:
        "If you could, would you choose to donate your organs to save another's life in the event you were to die in an accident?",
      answerText: ["Yes.", "No."],
      score: [1, -1],
      weight: [1, 1]
    },
    ...
    },
    {
      qid: "45831",
      text:
        "Imagine that you find a device that makes you invisible for one hour per day. Which of the following uses of the device would be most appealing to you?",
      answerText: [
        "Fighting evil.",
        "Illegally gaining wealth.",
        "Secretly observing people's private lives.",
    ...
    },
    {
      qid: "62075",
      text:
        "Would you stop to assist an injured person if you were already late for an important business meeting? Assume there is no one else around to help them.",
      answerText: ["Yes.", "No."],
      score: [1, -1],
      weight: [1, 1]
    },
    ...
    },
    {
      qid: "39226",
      text:
        "You stop to pick up a newspaper and notice that the coin-operated dispenser was not completely closed. No one is around so you have the oppurtunity to take a paper without paying. Which of the following would you do?",
      answerText: [
    ...
    },
    {
      qid: "93350",
      text:
        "If you were to discover that a person you know is a gay activist, would this change your opinion of them?",
    ...
    },
    {
      qid: "79842",
      text:
        "Imagine that you haven't eaten in 24 hours. You have just enough money for one meal. You are about to enter a restaurant when you notice a small, thin child off to the side, begging for food. No one else notices this child. Which would you do?",
      answerText: [
        "Buy myself a meal.",
        "Buy the child a meal.",
        "Take the child in and share a meal."
      ],
      score: [0, 1, 1],
      weight: [1, 1, 1]
    },
    ...
    },
    {
      qid: "81743",
      text:
        "A man steals money from a friend and is caught by the police.  The thief apologizes to his friend.  The friend forgives the thief and asks that any charges be dropped.  Should the thief still be punished by the legal system?",
      answerText: ["Yes.", "No."],
      score: [-1, 1],
      weight: [1, 1]
    },
    ...
    },
    {
      qid: "57757",
      text:
        "What do you think of corporations that give executives special parking spots and private bathrooms?",
      answerText: [
        "I like them - This is my kind of place to work.",
        "I don't like them - I would not work for one.",
        "This would not affect my opinion either way."
      ],
      score: [-1, 1, 0],
      weight: [1, 1, 1]
    },
    {
      qid: "44917",
      text:
        "Imagine you see a child playing in the tracks before an oncoming train. Without your physical intervention, it is almost certain that the child will be killed. Do you think that you would seriously risk your own life in an attempt to save the child?",
      answerText: ["Yes.", "No."],
      score: [1, -1],
      weight: [1, 1]
    },
    {
      qid: "81174",
      text:
        "Imagine you witness a man risk his life to save a child from drowning. When you see the man up close, you recognize his face as a bank robber who just escaped from jail. Which would you do?",
      answerText: [
        "Notify the authorities.",
        "Try to capture him myself.",
        "Disregard the fact he is an escaped convict.",
        "Help him evade capture."
      ],
      score: [-1, -1, 1, 1],
      weight: [1, 1, 0.5, 1]
    },
    {
      qid: "79043",
      text:
        "You find yourself in a bank. A masked man enters, brandishes a gun, and demands money from the teller. You are in a position to hit him over the head with a heavy object. You would probably knock him out. Would you take the chance and hit him?",
    ...
    },
    {
      qid: "50570",
      text:
        "If there were no welfare programs available in your community, which would you choose to help?",
      answerText: [
        "Give money directly to poor people.",
        "Give money to the government.",
        "Give money to a charity.",
        "Keep my money for myself, friends, and/or family."
      ],
      score: [1, -1, 1, -1],
      weight: [1, 1, 1, 1]
    },
    ...
    },
    {
      qid: "58660",
      text:
        "Is there any amount of money that could persuade you to murder someone whom you know nothing about?",
      answerText: ["Yes.", "No."],
      score: [-1, 1],
      weight: [1, 1]
    },
    ...
    },
    {
      ...
      answerText: [
        "No problem",
        "It's ok - if it is not abused",
        "Ok for short amounts of time",
        "Never - Get a job"
      ],
      score: [1, 0, 0, -1],
      weight: [1, 1, 1, 1]
    ...
    },
    {
      qid: "80571",
      text:
        "Would you rather have extreme wealth for yourself or provide every homeless person in the world a home?",
    ...
    },
    {
      qid: "23504",
      text:
        "Many people who are homeless have jobs. Assuming a person is not a substance abuser, do you think the law should punish their employers for not providing a living wage?",
      answerText: ["Yes", "No", "I'm Not Sure"],
      score: [1, -1, 0],
      weight: [1, 1, 1]
    },
    ...
    },
    {
      qid: "85158",
      text:
        "Would you support a system that would allow people to be free to live and work in any country in the world regardless of their citizenship or nation of birth?",
      answerText: ["Yes.", "No.", "I'm not sure."],
      score: [1, -1, 0],
      weight: [1, 1, 1]
    },
    {
      qid: "85155",
      text:
        "Should customs officials be allowed to search computer data in travelers' laptops at border crossings?",
      answerText: ["Yes.", "No."],
      score: [-1, 1],
      weight: [1, 1]
    },
    {
      qid: "85159",
      text:
        "In order to reduce crime, is it more effective to mandate harsher punishments or tackle the social and economic causes?",
    ...
    },
    {
      qid: "85380",
      text:
        "Should laws prohibit companies from drug testing employees who are in non-safety critical jobs?",
      answerText: ["Yes.", "No."],
      score: [1, -1],
      weight: [1, 1]
    },
    ...
    },
    {
      ...
      answerText: [
        ...
        "Join the opressive government",
        "Move/escape away to a benign power",
        "Break out the .50 sniper rounds"
      ],
      score: [1, -1, -1, 1],
      weight: [0.25, 1, 0.5, 1]
    },
    ...
    },
    {
      qid: "83107",
      text:
        "Imagine that your government asks every single citizen to provide a DNA sample to be archived. Would you support this?",
      answerText: ["Yes.", "No."],
      score: [-1, 1],
      weight: [1, 1]
    },
    {
      qid: "22055",
      text:
        'Do you know the difference between a communist and a socialist? (If you\'re not sure, that means the answer is "No.")',
      answerText: ["Yes", "No"],
      score: [1, 0],
      weight: [1, 1]
    },
    ...
    },
    {
      qid: "35482",
      text:
        "Assume you have a job where surfing the Internet is against the rules, would you surf the net anyway if there exists only a small chance of being caught?",
      answerText: [
        "Yes, even if I have work to do.",
        "Yes, but only after all my work is done.",
        "No, it would not be worth the risk.",
        "No, it would wrong - I'm not being paid for this."
      ],
      score: [0, 0, 0, -1],
      weight: [0, 0, 0, 1]
    },
    {
      qid: "176",
      text:
        "When rich people die, should they be allowed to will their money to their children, or should it be redistributed back to the people?",
    ...
    },
    {
      qid: "21093",
      text:
        "How willing would you be to sacrifice your life in order to save your country's Head of State (eg. Queen or President)",
      answerText: [
