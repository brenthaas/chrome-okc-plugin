_OKCP.fileQuestions.other = {
  artist: [
    {
      qid: "158",
      text: "Are you an aspiring actor/artist/writer or other creative type?",
      answerText: ["Yes", "No"],
      score: [1, -1]
    },
    {
  ...
  "morning-friendly": [
    {
      qid: "33170",
      text:
        "If/when you have NO pressing obligations (employment, schooling, children, errands, bedtime, or other factors aside), at what time do you prefer to get up in the morning?",
      answerText: [
  ...
  sports: [
    {
      qid: "6722",
      text: "Which best describes your personal feelings about sports?",
      answerText: [
  ...
  non_materialistic: [
    {
      qid: "6903",
      text: "Homemade/handmade gifts are more...",
      answerText: ["Thoughtful in a good way", "Cheap in a bad way"],
      score: [1, -1]
    },
    {
      qid: "8197",
      text: "Would you date someone who worked a minimum wage job?",
      answerText: ["Yes", "No"],
      score: [1, -1]
    },
    {
