...
_OKCP.fileQuestions.predator = {
  predator: [
    ...
    },
    {
      qid: "421574",
      text:
        "Have you ever been in a situation where you tried, but for various reasons did not succeed, in having sexual intercourse with an adult by using or threatening to use physical force (twisting their arm, holding them down—etc) if they didn't cooperate?",
      answerText: ["Yes", "No"],
      score: [-1, 1]
    },
    {
    ...
    },
    {
      ...
      answerText: [
        ...
        "Yes, but only where appropriate in competition.",
        "Yes, but only playfully or in jest.",
        "No, violence is never fun."
      ],
      score: [-1, 1, -1, 1]
    },
    {
    ...
    },
    {
      ...
      answerText: [
        "...super hot!",
        "...kind of interesting but I'm not sure.",
        "...like a bad joke.",
    ...
    },
    {
      ...
      answerText: [
        ...
        "s/s: submissive/submissive",
        "I'm too rolequeer for any of these."
      ],
      score: [-1, -1, 1, 1]
    }
  ]
