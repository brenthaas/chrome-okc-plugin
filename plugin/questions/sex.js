_OKCP.fileQuestions.sex = {
  ...
  oral_sex: [
    {
      ...
      answerText: [
        "I am passionate, and enjoy it as much as they do!",
        "I enjoy it as long as they recipricate.",
        "I would rarely and reluctantly perform oral sex.",
        "The idea of oral sex disgusts me!"
      ],
      score: [1, 0.75, -0.75, -1],
      weight: [1, 1, 1, 1]
    },
    {
      qid: "453695",
      text:
        "You are performing oral sex on your lover and they cum in your mouth. What is your reaction?",
      answerText: [
        "Swallow/Lap it up - Yum!",
        "Take it all, but spit it out afterwards.",
        "Get angry that they didn't warn you.",
        "I wouldn't do it. Oral sex is disgusting!"
      ],
      score: [1, 0.5, 1, -1],
      weight: [1, 1, 0, 1]
    },
  ...
  fetish: [
    ...
    },
    {
      ...
      answerText: [
        "Damn straight",
        "Well, I'm kinky, but not exactly proud",
        "Ewwww, kinky! Give me more missionary sex please.",
        "Huh?"
      ],
      score: [1, 1, -1, 0],
      weight: [1, 1, 1, 1]
    },
    {
      ...
      qid: "74018",
      text:
        "How do you feel about fisting? Fisting is where one inserts their entire hand into their partner's vagina (or anus).",
      answerText: [
        "I think it's disgusting / impossible",
        "I simply don't find it interesting",
        "I'd try it, but I'll need some practice first",
        "I already enjoy it / really want to try it"
      ],
      score: [-1, 0, 1, 1],
      weight: [1, 1, 1, 1]
    },
    {
      ...
      qid: "124568",
      text:
        "How far, sexually, are you willing to go with someone you've been dating for only a short time?",
      answerText: [
        "Not far at all, I'd keep it simple.",
        "I might try something new, just nothing kinky.",
        "I might trying something kinky",
        "Teach me something new! I'll do anything!"
      ],
      score: [-1, 0, 1, 1],
      weight: [1, 1, 1, 1]
    },
    ...
    },
    {
      ...
      qid: "37339",
      text:
        "Someone you're very attracted to admits to having a tickling fetish. Would you let them tickle you?",
      answerText: [
  ...
  rough_kinky: [
    {
      qid: "72894",
      text:
        "Could you date someone with many extreme sex fantasies,who wanted you to try some,but would never push you deeper than you were comfortable into any of them?",
      answerText: [
        "Good imagination and careful experiments?YES!",
        "No,if even THINKS weird stuff it's dangerous",
        "We'd talk and I'd see",
        "I'd rather be pushed deeper!"
      ],
      score: [1, -1, 0, 1],
      weight: [1, 1, 1, 1]
    },
    ...
    },
    {
      ...
      answerText: [
        ...
        "I think of my own M/s relationship "
      ],
      score: [-1, -1, 0.5, 1],
      weight: [1, 1, 1, 1]
    },
  ...
  sex_dress_up: [
    ...
    },
    {
      qid: "454087",
      text:
        "(For Women) How would you feel about dressing up as a sexy schoolgirl, teacher, secretary, nurse, librarian for your lover? (For Men) How excited would you be to have your lover dress like this for you?",
      answerText: [
        "I would love it - it turns me on too!",
        "It's okay, but does nothing for me.",
        "I've never experienced it, but want to try.",
        "Not interested. Wouldn't like it."
      ],
      score: [1, 0, 1, -1],
      weight: [1, 1, 0.5, 1]
    },
    {
      qid: "455973",
      text:
        "If your partner asked you to dress up in a sexy costume, or wear a special wig for sex, how would you feel?",
      answerText: [
        "I have an extensive sex wardrobe ready to go!",
        "I would be more than willing to try it!",
        "I would not be too enthusiastic about it.",
        "No way!"
      ],
      score: [1, 0.5, -0.5, -1],
      weight: [1, 1, 1, 1]
    },
    {
      qid: "453645",
      text:
        "For women, how do you feel about wearing sexy stockings, shoes, boots, lingerie, etc.? For men, how do you feel about wearing leather or other male-appropriate clothing for sex?",
      answerText: [
        "Turned on! I have an extensive wardrobe ready",
        "I am certainly willing to give it a chance!",
        "I would do it, but only every once in awhile.",
  ...
  sex_worker_positive: [
    ...
    },
    {
      ...
      answerText: [
        "Sure. At least they know what they're doing.",
        "No way!",
  ...
  BDSM: [
    ...
    },
    {
      qid: "456008",
      text:
        "Your partner suggests a night out at a closed private BDSM club, where you are allowed to use all of the special sex furnishings, such as saw horses, racks, bondage posts, and engage in sex with your partner in front of onlookers. What do you say?",
      answerText: [
        "Let's go!",
        "I might go to watch, but not participate.",
        "Uh, what does BDSM stand for?",
  ...
  switch: [
    ...
    },
    {
      ...
      answerText: [
        "Prefer to be the Dom or Top",
        "Prefer to be the sub or bottom",
        "I really like to switch.",
        "Not kinky or just too new to know my preference."
      ],
      score: [0, 0, 1, -1],
    ...
    },
    {
      ...
      answerText: [
        "I'd rather be the dominant person",
        "I'd rather be the submissive person",
        "It depends, I can go either way",
        "I'm not into it / don't know what it is"
      ],
      score: [0, 0, 1, -1],
      weight: [0.5, 0.5, 1, 1]
    },
    {
      qid: "158263",
      text:
        "Do you prefer to be the more submissive or dominant partner in the relationship?",
      answerText: [
        "Submissive",
        "Dominant",
        "I'm a switch(I can go either way or change)",
        "I don't like to think of relationships in this way"
      ],
      score: [-0.5, -0.5, 1, -0.5],
      weight: [1, 1, 1, 1]
    },
  ...
  bondage: [
    ...
    },
    {
      qid: "455986",
      text:
        "How do you feel about wearing gags (ball, ring, spider or dental) during sex?",
      answerText: [
        "Awesome, bring it on!",
        "I would be willing to do it occassionally, sure.",
        "I never have, but the idea excites me!",
        "Say what? Not or me!"
      ],
      score: [1, 0.5, 1, -1],
      weight: [1, 1, 0.5, 1]
    },
    {
      qid: "455994",
      text:
        "How do you feel about being restrained during sex with your partner?",
      answerText: [
        "Tie me up, tie me down baby! I'm wet already!",
        "I would be willing to do it for variety, sure!",
        "I've never done it, but the idea excites me!",
  ...
  anal: [
    ...
    },
    {
      ...
      answerText: [
        "Exploring their sexuality to the full",
        "Perverts",
  ...
  shaven: [
    ...
    },
    {
      ...
      qid: "1572",
      text:
        "Would you shave something you usually don't because your boyfriend/girlfriend asked you to?",
      answerText: ["Yes", "No"],
      score: [1, -1],
      weight: [1, 1]
    },
