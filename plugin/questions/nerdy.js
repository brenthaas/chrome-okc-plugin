// Books, Video Games, Board Games, Programming
_OKCP.fileQuestions.nerdy = {
  programmer: [
    {
      qid: "28741",
      text:
    ...
    },
    {
      qid: "84282",
      text:
        "Which best characterizes your reaction upon finding out that a mate or potential mate is skilled at a computer programming language?",
      answerText: ["Positive.", "Negative.", "Neutral."],
      score: [1, -1, 0],
      weight: [1, 1, 1]
    },
    {
  ...
  enjoys_board_games: [
    ...
    {
      qid: "1172",
      text: "Do you own any dice with more than six sides?",
      answerText: ["Yes", "No"],
      score: [1, -1],
      weight: [1, 1]
    },
    ...
    },
    {
      qid: "567",
      text:
        "Have you ever played a role playing game *other* than Dungeons and Dragons?",
      answerText: [
        "Yes",
        "No",
        "Yes, but not since I was 16.",
        "Yes, but I've grown to despise them."
      ],
      score: [1, -1, 1, 1],
      weight: [1, 1, 0.75, 0.5]
    },
  ...
  well_read: [
    {
      qid: "34662",
      text: "How many books do you own?",
      answerText: ["Less than 5", "5-25", "25-50", "50+"],
      score: [-1, 1, 1, 1],
      weight: [1, 0.5, 0.75, 1]
    },
    {
      qid: "542",
      text: "Roughly how many books have you read in the past year?",
      answerText: [
        "Less than five",
    ...
    {
      qid: "51354",
      text: "Do you borrow books from public libraries?",
      answerText: ["Regularly.", "Occasionally.", "Never."],
      score: [1, 1, -1],
      weight: [1, 0.75, 1]
    },
    {
      qid: "617",
      text:
        "If evil forces made you choose to either watch tv OR read books for the rest of your life, you would:",
      answerText: ["watch tv", "read books"],
      score: [-1, 1],
      weight: [1, 1]
    },
    {
