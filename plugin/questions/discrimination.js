...
_OKCP.fileQuestions.discrimination = {
  ...
  feminist: [
    ...
    },
    {
      ...
      answerText: [
        "She had it coming by wearing that outfit.",
  ...
  LGBT_nondiscriminating: [
    ...
    },
    {
      qid: "121451",
      text:
        "Would you think less of a person who is transgendered or attracted to people who are transgendered?",
      answerText: ["Yes", "No"],
      score: [-1, 1],
      weight: [1, 1]
    },
    {
      ...
      answerText: [
        ...
        "Fine, as long as they don't live near me.",
        "Ew, that's wrong/sick/immoral."
      ],
      score: [1, 1, -1, -1],
      weight: [1, 1, 0.5, 1]
    }
  ...
  weight_nondiscriminating: [
    //will change to weight_nondiscriminatory
    {
      qid: "52682",
      text:
    ...
    },
    {
      ...
      qid: "26292",
      text:
        "Would you date someone that is a little overweight but has a beautiful face?",
    ...
    },
    {
      ...
      qid: "18136",
      text:
        "Is it possible for full-figured (not fat) women to be equally attractive as thinner women?",
      answerText: ["Yes", "No"],
      score: [1, -1],
      weight: [0.5, 0.5]
    },
    ...
    },
    {
      ...
      answerText: [
        "As long as they are curves and not corners.",
        "Yes, women's bodies are beautful.",
        "No, i prefer women to be 2 dimensional.",
        "Mmm... * thinking about my hands on hips..."
      ],
      score: [1, 1, -1, 1],
      weight: [1, 1, 1, 1]
    }
