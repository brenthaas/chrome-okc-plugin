_OKCP.fileQuestions.domsub = {
  dominant: [
    {
      qid: "95139",
      text:
        "Would you enter into a 24/7 TPE Master, slave type relationship in which you would be collared, registered, placed under contract and be ruled 100% by your Master?",
      answerText: ["Yes", "No"],
      score: [-1, 0],
      weight: [1, 0]
    },
    ...
    },
    {
      qid: "86725",
      text:
        "If your partner wanted to cut his or her hair way shorter than you like it, what would you do?",
      answerText: [
    ...
    },
    {
      qid: "353294",
      text:
        "Sexually speaking, how dominant or submissive would you say you are?",
      answerText: [
        "Very Dominant",
        "Mostly Dominant",
        "Mostly Submissive",
    ...
    },
    {
      ...
      text: "Spankings?",
      answerText: [
        "I need them when I'm bad",
        "I give them when you're bad",
        "I take and receive",
        "No thanks"
      ],
      score: [-1, 1, 1, 0],
    ...
    },
    {
      ...
      answerText: [
        ...
        "No, i'm the one with the paddle!",
        "I'm Not Sure",
    ...
    },
    {
      qid: "72127",
      text:
        "If you found out the person you were dating was into some type of BDSM, how would you react?",
      answerText: [
        "Yes, but I want them to be dominant",
        "Yes, but I'd be dominant",
        "Not sure, but I'd be willing to try",
        "Absolutely not, were finished"
      ],
      score: [-1, 1, 1, 0],
      weight: [1, 1, 0.5, 1]
    },
    ...
    },
    {
      ...
      answerText: [
        "Yes! dom",
        "No, its wierd.",
        "maybe with the right person and comfort level",
        "Yes! sub"
      ],
      score: [1, 0, 0, -1],
      weight: [1, 1, 1, 1]
    ...
    },
    {
      qid: "85983",
      text:
        "Whether or not you have tried it, are you interested in dominating or submitting to your partner in the bedroom?",
      answerText: [
        "Yes, I'm interested in dominating my partner.",
        "Yes, I'm interested in submitting to my partner.",
        "Yes, I'm interested in both (switching).",
    ...
    },
    {
      ...
      answerText: [
        "Yes. It’s erotic and really turns me on.",
        "Yes. I’ve been naughty and need to be punished.",
        "No, I just spank others.",
        "No, I'm not into the whole spanking thing at all."
      ],
      score: [-1, -1, 1, 0],
      weight: [1, 1, 1, 1]
    },
    ...
    },
    {
      qid: "93463",
      text:
        "Would you ever consent to being a total submissive to another human being?",
      answerText: [
        "I would wear their collar at all times.",
        "I would be submissive in the bed room.",
        "I am willing to play along, occasionally.",
        "I am a dominant person, and could never submit."
      ],
      score: [-1, -0.75, -0.5, 1],
      weight: [1, 1, 1, 1]
    },
    ...
    },
    {
      ...
      answerText: [
        "slave, kajira(-us), toy, etc.",
        "servant, geisha, maid, secretary, etc.",
        "pain slut, scene bottom, etc.",
        "I don't know, am a Dom/me, or am not this kinky"
      ],
      score: [-1, -1, -1, 1],
      weight: [1, 1, 1, 1]
    },
    ...
    },
    {
      ...
      answerText: [
        "Very dominant",
        "Somewhat dominant",
        "Neutral or willing to take turns",
        "Submissive"
      ],
      score: [-1, -1, 0, 1],
      weight: [1, 0.7, 0.7, 1]
  ...
  submissive: [
    ...
    },
    {
      qid: "150317",
      text:
        "Have you ever become sexually aroused as a result of being spanked?\n",
      answerText: ["Yes", "No"],
      score: [1, 0],
      weight: [1, 0.5]
    },
    ...
    },
    {
      qid: "38320",
      text:
        "Is it generally acceptable to you for a sex partner to initiate foreplay while you are sleeping?",
      answerText: ["Yes.", "No."],
      score: [1, -1],
      weight: [1, 1]
    },
    ...
    },
    {
      qid: "79635",
      text:
        'How would you feel if someone called you "good girl" or "good boy" during sex?',
      answerText: [
        "Positive.",
        "Negative.",
        "Indifferent.",
    ...
    },
    {
      ...
      answerText: [
        "Yes.",
        "No.",
        "I am already totally 'natural' in this way."
      ],
      score: [1, 0, 0],
      weight: [1, 0, 0]
    },
