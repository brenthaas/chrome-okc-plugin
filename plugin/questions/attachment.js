...
_OKCP.fileQuestions.attachment = {
  "non-avoidant": [
    ...
    },
    {
      ...
      answerText: [
        "...wonderful!",
        "...okay, but right now I want to be open.",
        "...something I both fear and desire.",
    ...
    },
    {
      qid: "57105",
      text:
        "Have you ever purposely aggravated a partner to make them break up with you so you didn't have to do the dumping?",
      answerText: ["Yes.", "No."],
      score: [-1, 1]
    },
    {
  ...
  "non-anxious": [
    ...
    {
      qid: "61598",
      text: "Have you ever entered into a relationship out of desperation?",
      answerText: ["Yes.", "No."],
      score: [-1, 1]
    },
    {
    ...
    },
    {
      qid: "23338",
      text:
        "Your signifigant other has a hobby that you find boring. They're busy doing whatever it is they like to do, and you're bored. What do you do?",
      answerText: [
