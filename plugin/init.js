$(function() {
  ...
  // Questions Pages
  if (onPageQuestions) _OKCP.initSuggestQuestionsFeature(); // question suggestion feature

  // Pages with pagination missing
  if (onPageQuestions || onPageMailbox) _OKCP.initReaddPagination(); // re-adding pagination on questions and mailbox pages

  if (onPageMailbox) _OKCP.messageSearch();
