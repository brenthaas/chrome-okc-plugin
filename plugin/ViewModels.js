  ...
  $pageTabMenuParent.append(
    $("<ul>", { class: "okcp-pagetab okcp-pagetab-nav" }).append(
          ...
          $("<li>").append(
            $("<a>", {
              ...
              $("<div>", {
                ...
                text:
                  'This feature allows you to review profiles you\'ve previously marked as "Poly", "Message", and "Maybe". (Keep in mind that this data gets cleared if you clear your browser\'s cache.)'
              })
            )
          ),
          ...
          $("<li>").append(
            $("<a>", {
              ...
              $("<div>", {
                class: "okcp-feature-details",
                text:
                  "This feature allows you to choose which categories you care about. Drag categories from the right to the left to enable them, and vice-versa to disable them."
              })
            )
          ),
      ...
      $("<li>", { class: "okcp-pagetab-item okcp-pagetab-labels" }).append(
        ...
        $("<ul>", { class: "user_links" }).append(
          $("<li>").append(
            '<a class="okcp-btn toggleIsPoly" data-bind="click: toggleIsPoly, css: { checked: profileListData()[\'' +
              _OKCP.profileName +
              "'] ? profileList()['" +
              _OKCP.profileName +
...
function OKCP() {
  ...
  this.swapLargeThumb = function(vm, e) {
    ...
    $(".largeThumbViewerImage")
      .attr("src", chrome.extension.getURL("images/ajax-loader.gif"))
      .attr("src", largeThumbPath);
...
function applyBindingsToProfileThumb(
  objList,
  scopeOfBindingsStr,
  retry,
  largeThumbnailHoverEnabled
) {
  ...
  objList.each(function() {
    ...
    if (largeThumbnailHoverEnabled) {
      dataBind +=
        ", event: { mouseover: swapLargeThumb, mouseout: swapSmallThumb}";
    }
...
applyBindingsToProfileThumb(
  _OKCP.currentProfileImage,
  "#profile_thumbs",
  false,
  false
);
...
applyBindingsToProfileThumb(
  _OKCP.recentActivityUsersThumbs,
  "#recent_activity",
  false,
  true
);
...
applyBindingsToProfileThumb(
  _OKCP.favoritesThumbs,
  "#p_favorites #main_column",
  false,
  true
);
...
applyBindingsToProfileThumb(
  _OKCP.visitorsThumbs,
  "#p_stalkers #main_column",
  false,
  true
);

// quickmatch
_OKCP.quickmatchThumbs = $(
  "#p_votes #main_column .user_row_item, #p_likes #main_column .user_row_item"
);
...
if ($("#p_match").length !== 0) {
  //if we're on the matches page, enable the timer
